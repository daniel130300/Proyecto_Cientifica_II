...
namespace Registro
{
    public partial class FrmAgregarDocenteRegistro : Form
    {
        ...
        private void FrmAgregarDocente_Load(object sender, EventArgs e)
        {
            ...
            this.profesionesTableAdapter.Fill(this.escuela_BDDDataSet30.Profesiones);
            // TODO: This line of code loads data into the 'escuela_BDDDataSet29.Estado_Civil' table. You can move, or remove it, as needed.
            this.estado_CivilTableAdapter.Fill(this.escuela_BDDDataSet29.Estado_Civil);
            // TODO: This line of code loads data into the 'escuela_BDDDataSet28.Genero' table. You can move, or remove it, as needed.
            this.generoTableAdapter.Fill(this.escuela_BDDDataSet28.Genero);
            // TODO: This line of code loads data into the 'escuela_BDDDataSet27.Genero' table. You can move, or remove it, as needed.
            this.generoTableAdapter2.Fill(this.escuela_BDDDataSet27.Genero);
