...
namespace Registro
{
    public partial class FrmAgregarEncargado : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'escuela_BDDDataSet31.Genero' table. You can move, or remove it, as needed.
            this.generoTableAdapter2.Fill(this.escuela_BDDDataSet31.Genero);
            cientificaIIProyecto.frmAdministrador.Conexion conexion = new cientificaIIProyecto.frmAdministrador.Conexion();
